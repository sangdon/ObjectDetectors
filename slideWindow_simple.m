function [o_bbs] = slideWindow_simple(i_sqCellSize, i_type, i_imgSt, i_objMdl, i_valRectProp_cc)
...
featW = floor(size(i_imgSt.img, 2)/i_sqCellSize);
featH = floor(size(i_imgSt.img, 1)/i_sqCellSize);
defaultRect = [1; 1; featW; featH];
