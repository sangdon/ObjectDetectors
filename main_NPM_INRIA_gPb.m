...
% expID = 'exp_INRIA_gPbImg'; % AP: nearly 0
% expID = 'exp_INRIA_gPbImg_N0'; % AP: nearly 0
expID = 'exp_INRIA_gPbImg_N1'; % AP: nearly 0
...
params.db.annDir = [params.db.rootDir '/Annotations']; % pascal formatq
% params.db.imgDir = [params.db.rootDir '/JPEGImages']; % pascal format
params.db.imgDir = [params.db.rootDir '/JPEGImages_gPb']; % pascal format
...
params.feat.HOG.type = 3; % 1: HOG_UOCTTI, 2: 1 wo CN, 3: wo AN, 4: HObC, 5: HObC_N0 ?: HOG_UOCTTI_vlfeat
