...
% expID = 'exp_NPMwCN_Cal'; % AP: 0.983
% expID = 'exp_NPMwoCN_Cal'; % AP: 0.833
% expID = 'exp_NPMwoAN_Cal'; % AP: 950
expID = 'exp_NPM_HObC_high_tmp';
...
params.feat.HOG.type = 4; % 1: HOG_UOCTTI, 2: 1 wo CN, 3: wo AN, 4: HObC, ?: HOG_UOCTTI_vlfeat
...
params.test.scoreThres = -inf;
params.test.topN = 10;
params.test.nms = 1;
params.test.nmsOverlap = 0.5;
params.test.searchType = 2; % 1: exhuastive, 2: selective
% evalutate
